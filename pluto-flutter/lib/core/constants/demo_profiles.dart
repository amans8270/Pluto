...
const List<Map<String, dynamic>> demoProfiles = [
  {
    ...
    'photos': [
      {
        'id': 'ph_demo1',
        'gcs_url': 'assets/images/demo/swipe_guide.png',
        'display_order': 0
      }
    ],
  ...
  },
  {
    ...
    'photos': [
      {
        'id': 'ph_demo2',
        'gcs_url': 'assets/images/demo/chat_guide.png',
        'display_order': 0
      }
    ],
  ...
  },
  {
    ...
    'photos': [
      {
        'id': 'ph_demo3',
        'gcs_url': 'assets/images/demo/travel_guide.png',
        'display_order': 0
      }
    ],
  ...
  },
  {
    ...
    'photos': [
      {
        'id': 'ph_demo4',
        'gcs_url': 'assets/images/demo/profile_guide.png',
        'display_order': 0
      }
    ],
  ...
  },
  {
    ...
    'photos': [
      {
        'id': 'ph_demo5',
        'gcs_url': 'assets/images/demo/safety_guide.png',
        'display_order': 0
      }
    ],
